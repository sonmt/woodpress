...
get_header( 'shop' ); ?>
	...
	<h1 class="page-title"><?php _e( 'Customer Ratings', 'techmarket' ); ?></h1>
	...
	<?php if ( $vendor_feedback ) {
		...
		foreach ( $vendor_feedback as $vf ) {
			...
			<div class="single-rating">
				<p>
					<?php _e('Product: ', 'techmarket'); ?>
					<a href="<?php echo $product_link; ?>" target="_blank"><?php echo $product_title; ?></a>
				</p>
				<p>
					<span><?php _e( 'Posted on ', 'techmarket'); echo $post_date; ?></span>
					<?php _e( ' by ', 'techmarket'); echo $customer_name; ?>
				</p>
				<div class="review-container">
					<div class="value">
						<div class="rate-stars"><?php echo $stars; ?></div>
					</div>
					<div class="rating-review">
						<?php if ( ! empty( $rating_title ) ) { echo '<h6>'.$rating_title.'</h6>'; } ?>
		...
		<?php }
	} else {  echo __( 'No ratings have been submitted for this vendor yet.', 'techmarket' ); }  ?>

	<a class="button" href="<?php echo $vendor_shop_url; ?>"><?php _e( 'Return to store', 'techmarket' ); ?></a>
